...
def index():
    ...
    if search_article:
        ...
        return render_template('index.html', title=title, business_news_sources =business_news_sources, technology_news_sources=technology_news_sources, entertainment_news_sources=entertainment_news_sources, sports_news_sources=sports_news_sources)
